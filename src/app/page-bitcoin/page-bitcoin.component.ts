...
@Component({
  selector: 'app-page-bitcoin',
  templateUrl: './page-bitcoin.component.html',
  styleUrls: ['./page-bitcoin.component.scss']
})
export class PageBitcoinComponent implements OnInit {
